        ...
        [
          {
            text: "Continue",
            onPress: () => {
              this._isMounted && this.setState({ isSelectionTipVisible: true });
            }
          }
        ]
      );
                ...
                setTimeout(() => {
                  if (responseJSON.message == null) {
                    ...
                    Alert.alert(
                      ...
                      "Thank you for reporting. We will solve this issue as soon as possible.",
                      [
                        {
                          text: "OK",
                          onPress: () => {
              ...
              <View style={styles.container}>
                ...
                <View style={styles.reportContainer}>
                  <View style={styles.reportSubcontainer}>
                    ...
                    <View style={styles.incidentsScrollContainer}>
                      <ScrollView
                        class="incidentsContainer"
                        contentContainerStyle={styles.incidentsContainer}
                      >
                    ...
                    >
                      <View style={styles.tipBubbleSquare}>
                        ...
                        >
                          <Text style={styles.stopTips}>Stop showing tips</Text>
                        </TouchableOpacity>
                      </View>
                  ...
                  <View style={styles.reportSubcontainer}>
                    ...
                    <TextInput
                      ...
                      onContentSizeChange={event =>
                        this._isMounted &&
                        this.setState({
                          IncDescheight: event.nativeEvent.contentSize.height
                        })
                      }
                      style={[
                        styles.textInput,
                        {
                          height: Math.min(
                            maxTextHeight,
                            Math.max(minTextHeight, this.state.IncDescheight)
                          )
                        }
                      ]}
                    ...
                    <Text style={styles.fieldFooterBackground}>
                      Characters Left:{" "}
                      {maxDescLength - this.state.incidentDesc.length}/
                      {maxDescLength}
                    </Text>
                    <View
                      animationType="fade"
                    ...
                    >
                      <View style={styles.tipBubbleSmaller}>
                        <Text style={styles.mainTipText}>
                          Describe the problem in detail. For example, “I almost
                          tripped in the hall because it is very dark.”
                        </Text>
                        <TouchableOpacity
                          onPress={() => {
                            this._isMounted &&
                  ...
                  <View style={styles.reportSubcontainer}>
                    ...
                    <TextInput
                      ...
                      onChangeText={incidentLocationDesc => {
                        if (incidentLocationDesc.slice(-1) === "\n") {
                          this.swiper.scrollBy(1);
                          Keyboard.dismiss();
                        } else {
                          var pre_report = this.state.pre_report;
                      ...
                      onContentSizeChange={event =>
                        this.setState({
                          LocDescheight: event.nativeEvent.contentSize.height
                        })
                      }
                      style={[
                        styles.textInput,
                        {
                          height: Math.min(
                            maxTextHeight,
                            Math.max(minTextHeight, this.state.LocDescheight)
                          )
                        }
                      ]}
              ...
              <View style={styles.container}>
                ...
                <View style={styles.reportContainer}>
                  <View style={styles.reportSubcontainer}>
                    ...
                    >
                      <View style={styles.tipBubbleSquare}>
                        <Text style={styles.mainTipText}>
                          ...
                          report, press the "Camera” button. If you would prefer
                          to select one from the gallery, press “Gallery”.
                        </Text>
                        <TouchableOpacity
                          onPress={() => {
                            this._isMounted &&
                    ...
                    <View>
                      ...
                      >
                        <View style={styles.tipBubbleSquare}>
                          <Text style={styles.mainTipText}>
                            If you wish to take a photo or video to add to the
                            report, press the "Camera” button. If you would
                            prefer to select one from the gallery, press
                            “Gallery”.
                          </Text>
                          <TouchableOpacity
                            onPress={() => {
                        ...
                        onPress={() => {
                          if (this.state.hasCameraPermission) {
                            ...
                            this.props.navigation.navigate("Camera", {
                              callBack: this.returnFromCamera.bind(this)
                            });
                          } else {
                            alert(
                    ...
                    >
                      <View style={styles.tipBubbleSmallest}>
                        <Text style={styles.mainTipText}>
                          To mark the location of the incident, press the “Mark
                          location” button.
                        </Text>
                        <TouchableOpacity
                          onPress={() => {
                    ...
                    >
                      <Icon
                        ...
                        style={styles.btnTextWhite}
                      />
                      <Text style={styles.btnTextWhite}>Mark on Map</Text>
                    </TouchableOpacity>
                  </View>
                  <View
                    animationType="fade"
                  ...
                  >
                    <View style={styles.tipBubbleSmallest}>
                      <Text style={styles.mainTipText}>
                        You can click on the thumbnail above to view the
                ...
                <View style={styles.reportContainer}>
                  <View style={styles.reportSubcontainer}>
                      ...
                      <Text
                        style={[
                          styles.textInput,
                          {
                            height: Math.min(
                              120,
                              Math.max(35, this.state.IncDescheight)
                            )
                          }
                        ]}
                      >
                      ...
                      <Text
                        style={[
                          styles.textInput,
                          {
                            height: Math.min(
                              120,
                              Math.max(35, this.state.LocDescheight)
                            )
                          }
                        ]}
                      >
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        if (this.state.incidentCategory == "") {
                          Alert.alert(
                            "Incomplete Report",
                        ...
                        } else if (this.state.incidentDesc == "") {
                          Alert.alert(
                            "Incomplete Report",
                        ...
                        } else if (this.state.incidentLocationDesc == "") {
                          Alert.alert(
                            "Incomplete Report",
                          ...
                          this.state.pre_report.incidentLatitude == null
                        ) {
                          Alert.alert(
                            "Incomplete Report",
                          ...
                          this.state.pre_report.incidentLongitude == null
                        ) {
                          Alert.alert(
                            "Incomplete Report",
                            "Please mark the location of the incident on the map.",
                  ...
                  >
                    <View style={styles.tipBubbleBig}>
                      <Text style={styles.mainTipText}>
                        ...
                        (recall that it will not actually be sent while in tour
                        mode), or “cancel” to erase the test report.
                      </Text>
                      <TouchableOpacity
                        onPress={() => {
                          this._isMounted &&
